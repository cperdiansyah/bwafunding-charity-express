...
import {
  generateSedekahSubuhReport,
  previewSedekahSubuhReport,
} from '../controller/sedekah-subuh.js'

const router = express.Router()

// /* Get Route */
// router
router.route('/campaign/:id').get(generateCampaignReport)

router.route('/sedekah-subuh').get(generateSedekahSubuhReport)
